...
?>
<div class="loginbox">
<form name="registration" method="post" action="studentreg.php">
<!-- we will create registration.php after registration.html -->
Student Name:<input type="text" name="name" value="" class="un"></br>
EMAIL-ID:<input type="text" name="email" value="" class="un"></br>
PASSWORD:<input type="text" name="password" value="" class="un"></br>
Enrolment Code:<input type="text" name="enroll" value="" class="un"></br>
